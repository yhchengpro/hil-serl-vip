...
from airbot_env.camera.multi_video_capture import MultiVideoCapture
...
class AirbotWrenchEnv(gym.Env):
    def __init__(
        ...
        # TODO: Pass reset pose from config to airbot server and avoid hardcoding 
