...
class EnvConfig(DefaultEnvConfig):
    ...
    IMAGE_CROP = {
        ...
        "env_close": lambda img: img[80:630, 100:680],
    ...
    SAFEBOX_MAX = [0.494, 0.15, 0.34, 0.37, 0.71, 0.62, 0.96]
    SAFEBOX_MIN = [0.22, -0.34, 0.1, -0.12, 0.039, -0.66, -0.78]
    GRIPPER_IS_STATIC = True
    GRIPPER_STATIC_POS = 1
    GO_TO_RESET = True
    RANDOM_RESET = False
    DISPLAY_IMAGE = True
