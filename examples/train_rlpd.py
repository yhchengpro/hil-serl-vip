...
flags.DEFINE_integer("train_start_step", 0, "Step to resume train the checkpoint.")
...
flags.DEFINE_boolean("show_demo", False, "show_demo.")
...
def main(_):
    ...
    if FLAGS.checkpoint_path is not None and os.path.exists(FLAGS.checkpoint_path):
        ...
        if FLAGS.train_start_step != 0:
            start_step = FLAGS.train_start_step
        else:
            start_step = os.path.basename(
        ...
        print_green(f"Loaded previous checkpoint at step {start_step}.")
